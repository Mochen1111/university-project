...
<div class="h"><h1>物品添加</h1></div>
<div class="alltable">
    <form action="${pageContext.request.contextPath}/InsertGood" method="post">
        <table>
            <tr>
                <td>楼号：</td><td><input type="text" name="aid" required></td>
            </tr>
            <tr>
                <td>宿舍号：</td><td><input type="text" name="rid" required></td>
            </tr>
            <tr>
                <td>物品名称：</td><td><input type="text" name="gname" required></td>
            </tr>
            <tr>
                <td>物品数量：</td><td><input type="text" name="gnumber" required></td>
            </tr>
            <tr>
                <td colspan="2"><input class="btn1" type="submit" value="提交"></td>
            </tr>
        </table>
    </form>
</div>
